 ...
 * @property string $generateRelations
 * @property boolean $generateRelationsFromCurrentSchema
 * @property boolean $generateLabelsFromComments
 * @property boolean $useTablePrefix
 * @property boolean $useSchemaName
 * @property boolean $generateQuery
 * @property string $queryNs
...
class Generator extends \yii\gii\Generator
{
    ...
    public $queryNs = 'common\components';
    public $queryClass;
    ...
    {
        return 'This generator generates an AR model and entity class for the specified database table.';
    }
    ...
    public function generate()
    {
        ...
        foreach ($this->getTableNames() as $tableName) {
            ...
            $files[] = new CodeFile(
                \Yii::getAlias('@' . str_replace('\\', '/', $this->ns)) . '/' . $modelClassName . 'AR.php',
                $this->render('model-ar.php', $params)
            );
    ...
    /**
     * генерит название AR модели из названия класса сущности
     * @param string $className
     * @return string
     */
    protected function generateClassARName(string $className) : string
    {
        return $className . 'AR';
    }

    /**
     * генерит название Form модели из названия класса сущности
     * @param string $className
     * @return string
     */
